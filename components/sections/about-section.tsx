      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              I specialize in building modern web applications using the latest technologies. My journey in web development started over 2 years ago, and I&apos;ve been passionate about creating intuitive and performant digital experiences ever since.
            </p>
            <p>
